...
function GenerateQuadsBricks(atlas)
    ...
    -- 1, 21 refers to the index of all the bricks. If you look at breakout.png, you will realise
    --that there are 21 bricks in total to index
...
--This function is made specifically to piece out the powerups from the sprite sheet
function GeneratePowerups(atlas)

    --first powerup starts at y = 192
    local x = 0
    local y = 192
    ...
    --there are 10 powerups in total
    for i = 0, 9 do
        --each powerup is 16 x 16
